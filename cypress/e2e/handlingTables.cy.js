describe('Handling Tables',()=>{
    ...
    //beforeEach block will execute every time before executing ervery it block, it is called hook.
    beforeEach('Login',()=>{
       ...
       it.skip('Reading all the rows & Colimn data in the first page',()=>{
